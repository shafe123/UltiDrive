...
namespace UltiDrive.Dropbox.Api
{
    public class DropboxApi
    {
        ...
        private static string _consumerKey = "p6qe2ckxfj8yzwp";
        private static string _consumerSecret = "fu5jgon7e4qu46s";

        private DropboxApi()
        {
        }

        public static DropboxApi Api
        {
            get
            {
                if (api == null)
        ...
        public Api.File GetFiles(string root, string path)
        {
